...
def convert(filename_str, coords):
    ...
    coords[0] = image.shape[0]-ymax
    coords[1] = image.shape[1]-xmax
    coords[2] = image.shape[0]-ymin
    coords[3] = image.shape[1]-xmin
    os.chdir("Label")
    return coords
                ...
                for filename in tqdm(os.listdir(os.getcwd())):
                    ...
                    if filename.endswith(".txt"):
                        ...
                        with open(filename) as f:
                            ...
                            f.close()
                        os.chdir("Label_90")
                        with open(filename_str+"_90_ud.txt", "w") as outfile:
